...
def worker(f1, f2):
  ...
  os.system("/afs/cern.ch/work/v/vavolkl/public/heppy_analysis_samples/heppy/FCChhAnalyses/FCChh/tth_4l/src/heppyanalysis " + "tree_" + f1[0].split("events_")[1] + " " +  "  ".join("root://eospublic//eos/experiment/fcc/hh/generation/DelphesEvents/fcc_v02/"+ process +"/" + _f for _f in f1))
